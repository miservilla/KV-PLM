...
text_file_path = '/data_link/servilla/KV-PLM/chebi_name_smiles_definition_183_no_names.txt'
...
with open('/data_link/servilla/KV-PLM/tokenized_text_183', 'w', encoding='utf-8') as out_file:
    for tokenized_line in tokenized_data:
        out_file.write(' '.join(tokenized_line) + '\n')

with open('/data_link/servilla/KV-PLM/tokenized_text_183', 'r') as file:
    content = file.read()
